...
module com.enesuzun.ibb_ecodation_javafx {
    ...
    opens com.enesuzun.ibb_ecodation_javafx.database to java.sql;
    ...
    exports com.enesuzun.ibb_ecodation_javafx.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.enesuzun.ibb_ecodation_javafx.database;
